...
import library.intrpolation as ip
import library.spline as spl
from library.format import format_polynom
import library.least_squares as ls
import library.diff as diff
import library.integrate as integrate
...
def lab03_01():
    ...
    print('Value at X*:', ip.evaluate_polynom(polynom, x_), end='\n\n')
...
def lab03_04():
    ...
    print(f"First f'({x_}) = {diff.df(x, y, x_)[0]:.4f}")
    print(f"Second f'({x_}) = {diff.df(x, y, x_)[1]:.4f}")
...
def lab03_05():
    ...
    rectangle_h1 = integrate.rectangle(f, x0, xk, h1)
    rectangle_h2 = integrate.rectangle(f, x0, xk, h2)
    trapeze_h1 = integrate.trapeze(f, x0, xk, h1)
    trapeze_h2 = integrate.trapeze(f, x0, xk, h2)
